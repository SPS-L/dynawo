...
TEST(ModelsModelNetwork, ModelNetworkTwoWindingsTransformerDiscreteVariables) {
  ...
  ASSERT_EQ(t2w->evalZ(10., onlyEvaluateStateChange), NetworkComponent::TOPO_CHANGE);
  ...
  ASSERT_THROW_DYNAWO(t2w->evalZ(10., onlyEvaluateStateChange), Error::MODELER, KeyError_t::NoThirdSide);
  ...
  ASSERT_EQ(t2w->evalZ(10., onlyEvaluateStateChange), NetworkComponent::STATE_CHANGE);
...
TEST(ModelsModelNetwork, ModelNetworkTwoWindingsTransformerOpenedDiscreteVariables) {
  ...
  z[ModelTwoWindingsTransformer::connectionStateNum_] = CLOSED;
  ASSERT_EQ(t2w->evalZ(10., onlyEvaluateStateChange), NetworkComponent::NO_CHANGE);
