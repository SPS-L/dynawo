...
SolverKINEuler::init(const std::shared_ptr<Model>& model, Solver* timeSchemeSolver, const double fnormtol, const double initialaddtol,
  const double scsteptol, const double mxnewtstep, const int msbset, const int mxiter, const int printfl, const N_Vector sundialsVectorY, bool printResiduals) {
  clean();
  model_ = model;
  timeSchemeSolver_ = timeSchemeSolver;
  printResiduals_ = printResiduals;
