...
class XmlExporter : public Exporter {
 public:
   ...
   */
  void exportToFile(const std::shared_ptr<LostEquipmentsCollection>& lostEquipments, const std::string& filePath) const override;
   ...
   */
  void exportToStream(const std::shared_ptr<LostEquipmentsCollection>& lostEquipments, std::ostream& stream) const override;
};
