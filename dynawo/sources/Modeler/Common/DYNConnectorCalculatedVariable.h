...
class ConnectorCalculatedVariable : public SubModel {
 public:
  ...
  /**
   * @copydoc SubModel::init(double t0)
   */
  ...
  */
   ...
   */
  void setGequations() override { /*no G equation*/ }
   ...
   */
  void setGequationsInit() override { /*no G equation*/ }
  ...
  const std::string& modelType() const override {
    static std::string modelType = "ConnectorCalculatedVariable";
    return modelType;
  }
