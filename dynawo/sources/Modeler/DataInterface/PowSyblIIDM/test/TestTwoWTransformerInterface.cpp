...
TEST(DataInterfaceTest, TwoWTransformer_1) {
  ...
  transformer.newRatioTapChanger()
    ...
    .add();
  std::unique_ptr<RatioTapChangerInterface> ratioTapChangerItf = DYN::make_unique<RatioTapChangerInterfaceIIDM>(transformer.getRatioTapChanger(),
                                                                                                                tfoInterface.getID());
  ...
  transformer.newPhaseTapChanger()
    ...
    .add();
  std::unique_ptr<PhaseTapChangerInterface> phaseTapChangerItf = DYN::make_unique<PhaseTapChangerInterfaceIIDM>(transformer.getPhaseTapChanger());
