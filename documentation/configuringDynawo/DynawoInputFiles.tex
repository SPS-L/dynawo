...
The columns, in order, are \texttt{phase}, \texttt{total\_seconds}, \texttt{exclusive\_seconds}, \texttt{call\_count}, \texttt{min\_ms} and \texttt{max\_ms}. The first three columns, total time, exclusive time and call count, are expressed in seconds; the last two, the shortest and longest single measurement recorded for the phase, are expressed in milliseconds.
